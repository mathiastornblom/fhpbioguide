...
**Tech Stack:** `log/slog` (Go stdlib ≥1.21), `gopkg.in/natefinsh/lumberjack.v2` (log rotation), existing Viper config.
...
Expected: `gopkg.in/natefinsh/lumberjack.v2 v2.x.x`
